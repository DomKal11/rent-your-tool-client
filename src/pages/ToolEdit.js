            ...
            <form onSubmit={handleSubmit}>
              <table>
                <tbody>
                  ...
                  <tr><td></td><td><span className="button-design" onClick={(e) => getGps()}>Get GPS</span></td></tr>
                  <tr>
                    <td>Lat:</td>
                    <td>
                      <input
                  ...
                  <tr><td></td><td><button type="submit" className="button-design">Save changes</button></td></tr>
                </tbody>
              </table>
              </form>
            </div>
